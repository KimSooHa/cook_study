...
- 개발 목적
  ...
  - Docker를 이용해 애플리케이션의 컨테이너화 및 효율적인 배포 구현
- 개발 환경: IntelliJ IDE 2022.2.4(Community Edition), SpringBoot 2.7.7, Spring Security 5.7.6, JDK 11, Mariadb 3.0.9, Gradle, Lombok 1.18.24, Spring Data JPA 2.7.7, Querydsl 5.0.0, Junit5, Ehcache 3.10.8, HTML, CSS, Javascript, Thymeleaf, AWS(EC2, RDS), Docker

## 아키텍처
  ![architecture](https://github.com/user-attachments/assets/474a825b-d3b0-4cf8-85aa-41eb5b2b0232)
...
- 구현 기능 설명
    ...
    - Spring Security의 form login 방식으로 인증처리합니다.
...
> AWS를 통해 운영서버에 배포하였습니다. 현재는 요금 문제로 서버를 내린 상태입니다.
> 

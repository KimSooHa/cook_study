...
public class JwtTokenizer {
    ...
    public String createAccessToken(Long id, String loginId) {
        return createToken(id, loginId, ACCESS_TOKEN_EXPIRE_COUNT, accessSecret);
    }
    ...
    public String createRefreshToken(Long id, String loginId) {
        return createToken(id, loginId, REFRESH_TOKEN_EXPIRE_COUNT, refreshSecret);
    }

    public String createToken(Long id, String loginId, Long expire, byte[] secretKey) {
